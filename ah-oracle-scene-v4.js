...
(function() {
  ...
  // ============================================================
  // SCENE CONFIG DEFAULTS (for sceneBuilder)
  // ============================================================
  ...
  function readSceneConfig() {
    if (!DOM.sceneConfig) {
      console.log('ℹ️ No scene-config element found, using defaults');
      return { ...SCENE_CONFIG_DEFAULTS };
    }
  ...
  function startSceneAnimations() {
    if (!window.sceneBuilder) {
      console.warn('⚠️ sceneBuilder not available');
      return;
    }
    ...
    if (!config) {
      console.warn('⚠️ No scene config available');
      return;
    }
  ...
  function stopSceneAnimations() {
    if (window.stopAllAnimations) {
      ...
      console.log('⏹️ Scene animations stopped');
    }
  }
  ...
  function stopFacetAnimation() {
    if (window.activeScene && window.activeScene.stopFacets) {
      window.activeScene.stopFacets();
      console.log('⏹️ Facet animations stopped');
    }
  }
